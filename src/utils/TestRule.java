...
//					}
//				}
//				logger.error("DESISTINDO APÓS " + tentativas + " TENTATIVAS");
...
//		//		String suiteName = description.getClassName().toString();
//		//		suiteName = suiteName.replace("tests.regressao2.", " ");
...
//			//			imageCabecalho.scaleToFit(594, 90);
...
//			Paragraph p1 = new Paragraph("Resumo do cenário de teste " + "[M"+ new PropertiesNovaPontoCom().getSeleniumProperties("url.msite") + "] ", f);
