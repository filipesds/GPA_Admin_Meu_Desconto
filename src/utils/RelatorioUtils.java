...
//	public static String caminhoWindowsHML = "C:\\Jenkins_WorkspaceTeste\\workspace\\PF-RelatorioGermud\\relatorios\\img\\";
//	
//	
//
...
//					" <th style=' font-weight: bold;text-align:left;background:#ffc000;' >Errors</th>  " +
...
//		
//        try {
//            PdfWriter.getInstance(document, new FileOutputStream(projeto + "/PF-Germud.pdf"));
//            document.open();
//            
...
//            	document.add(img);
//            	
//            	Image imgbandeira = Image.getInstance(projeto + "/evidencias/config/PF.png");
//            	int indentation2 = 0;
//
...
//			   }else{
//				  nomeCenario = nomeCenario.replace(caminhoWindowsHML, "");
//			   }
//		   }else{
